# 实验批次报告: batch_20250813_1634

## 基本信息

- **批次编号**: batch_20250813_1634
- **体系类型**: silicate
- **目标参数**: α=0.150, ε=0.850
- **生成时间**: 2025-08-13 16:34:47
- **处理耗时**: 0.06秒
- **备注**: 多目标优化测试
...
**Top-3 引用文献**:
1. fallback_ref_0 (引用5次)
2. fallback_ref_1 (引用5次)
3. fallback_ref_2 (引用5次)
